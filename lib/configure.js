...
<body>
  <div class="container">
    ...
    <div class="tagline">No API key required. Catalogs refresh daily server-side. Use the year and category filters in your Stremio client to narrow down each catalog. By default, the most recent year is shown.</div>

    <div class="section-label">Exclude sources / catalogs</div>
    <div class="checkboxes">
      ${checkboxes.map(renderCheckbox).join("")}
    </div>
